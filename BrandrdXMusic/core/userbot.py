...
class Userbot(Client):
    ...
    async def start(self):
        ...
        if config.STRING1:
            ...
            try:
                await self.one.join_chat("love_mhe")
                await self.one.join_chat("love_mhe")
                await self.one.join_chat("vibes_I")
        ...
        if config.STRING2:
            ...
            try:
                await self.two.join_chat("love_mhe")
                await self.two.join_chat("love_mhe")
                await self.two.join_chat("vibes_I")
        ...
        if config.STRING3:
            ...
            try:
                await self.three.join_chat("love_mhe")
                await self.three.join_chat("love_mhe")
                await self.three.join_chat("vibes_I")
        ...
        if config.STRING4:
            ...
            try:
                await self.four.join_chat("love_mhe")
                await self.four.join_chat("love_mhe")
                await self.four.join_chat("vibes_I")
        ...
        if config.STRING5:
            ...
            try:
                await self.five.join_chat("love_mhe")
                await self.five.join_chat("love_mhe")
                await self.five.join_chat("vibes_I")
